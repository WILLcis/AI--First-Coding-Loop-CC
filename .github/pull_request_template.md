<!-- 这份模板自动出现在每个新 PR 的描述里。规则源:skills/agent-coding-discipline/SKILL.md -->
...
来源:[`skills/agent-coding-discipline/SKILL.md`](../blob/main/claude-code/skills/agent-coding-discipline/SKILL.md)
